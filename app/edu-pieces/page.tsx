  ...
  return (
    <div className="mb-32">
      <div className="flex flex-col px-10 md:px-24">
        <h2 className="mb-12 md:mb-24 text-pink-300 italic text-4xl/relaxed md:text-7xl/relaxed text-center">Mosaics to Memorialize Our Martyrs</h2>
        <BisanOwda />
        <RefaatAlAreer />
        <ShireenAbuAkleh />
        ...
        <div className="mb-16">
          <h2 className="md:text-8xl/relaxed italic text-yellow-300 text-center mb-6">How to use the Indigenous Art for Education Pieces?</h2>
